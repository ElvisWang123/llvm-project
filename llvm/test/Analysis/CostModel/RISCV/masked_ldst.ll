...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 254 for instruction: %v32f16 = call <32 x half> @llvm.masked.load.v32f16.p0(ptr undef, i32 8, <32 x i1> undef, <32 x half> undef)
